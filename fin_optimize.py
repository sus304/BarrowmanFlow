...
class Config:
    def __init__(self):
        ...
        self.root_chord = 300.0 / 1000.0 # [m]

        self.tip_chord_max = 300.0 / 1000.0 # [m]
        self.tip_chord_min = 10.0 / 1000.0 # [m]
        self.leading_edge_chord_max = 300.0 / 1000.0 # [m]
...
print('Safety Ratio of Length:', (config.stage.Lcp - config.length_cg) / config.length_body * 100.0, '[%]')
